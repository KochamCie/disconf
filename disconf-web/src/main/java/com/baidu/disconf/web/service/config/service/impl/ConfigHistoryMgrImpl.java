...
public class ConfigHistoryMgrImpl implements ConfigHistoryMgr {
    ...
    public ConfigHistory getLastByConfigId(Long configId, int lastWhich) {
        ...
        return configHistoryDao.getLastByConfigId(configId, lastWhich);
    }

    @Override
    public List<ConfigHistory> getConfigHistoryList(Long configId) {
        return configHistoryDao.getConfigHistoryList(configId);
    }
    ...
    public DaoPageResult<ConfigHistory> getConfigHistoryList(Long configId, ConfHistoryListForm confHistoryListForm) {
        ...
        // 数据据结果
        //
        DaoPageResult<ConfigHistory> configHistoryList = configHistoryDao.getConfigHistoryList(configId, confHistoryListForm);
