...
>>>>>>> 2ac5c8275ad8cdc101522ad01a8ba87e53b73b68
    ...
    public List<RoleResource> getRoleResource(int roleId) {
        return roleResDao.getRoleResource(roleId);
    }

    @Override
    public void createOne(RoleResourceForm roleResourceForm) {
        RoleResource roleResource = new RoleResource();
        roleResource.setMethodMask(MethodEnum.getIfPresent(roleResourceForm.getMethodMask()).getKey());
        roleResource.setRoleId(roleResourceForm.getRoleId());
        roleResource.setUpdateTime(DateUtils.format(new Date(), DataFormatConstants.COMMON_TIME_FORMAT));
        roleResource.setUrlDescription(roleResourceForm.getUrlDescription());
        roleResource.setUrlPattern(roleResourceForm.getUrlPattern());
        roleResDao.create(roleResource);
    }
