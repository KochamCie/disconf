...
public class UserController extends BaseController {
     ...
     */
    @NoAuth
    @RequestMapping(value = "/session", method = RequestMethod.GET, name = "获取当前用户session信息")
    @ResponseBody
     ...
     */
    @NoAuth
    @RequestMapping(value = "/signin", method = RequestMethod.POST, name = "用户登陆")
    @ResponseBody
     ...
     */
    @NoAuth
    @RequestMapping(value = "/signout", method = RequestMethod.GET, name = "退出")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/password", method = RequestMethod.PUT, name = "修改密码")
    @ResponseBody
