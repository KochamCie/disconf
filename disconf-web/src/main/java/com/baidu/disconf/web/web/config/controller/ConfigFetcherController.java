...
public class ConfigFetcherController extends BaseController {
     ...
     */
    @NoAuth
    @RequestMapping(value = "/list", method = RequestMethod.GET, name = "获取指定app env version 的配置项列表")
    @ResponseBody
    ...
    @NoAuth
    @RequestMapping(value = "/simple/list", method = RequestMethod.GET, name = "获取指定app env version 的配置项列表")
    @ResponseBody
     ...
     */
    @NoAuth
    @RequestMapping(value = "/item", method = RequestMethod.GET, name = "获取配置项")
    @ResponseBody
     ...
     */
    @NoAuth
    @RequestMapping(value = "/file", method = RequestMethod.GET, name = "获取配置文件")
    @ResponseBody
