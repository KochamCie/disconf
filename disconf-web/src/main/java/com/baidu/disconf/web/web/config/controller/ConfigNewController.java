...
public class ConfigNewController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = "/item", method = RequestMethod.POST, name = "配置项的新建")
    @ResponseBody
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/file", method = RequestMethod.POST,name = "配置文件的新建(使用上传配置文件)")
     ...
     */
    @ResponseBody
    @RequestMapping(value = "/filetext", method = RequestMethod.POST, name = "配置文件的新建(使用文本)")
