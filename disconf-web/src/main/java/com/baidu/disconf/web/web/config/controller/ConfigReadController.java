...
public class ConfigReadController extends BaseController {
    ...
    @Autowired
    private ConfigHistoryMgr configHistoryMgrMgr;
     ...
     * @return
     */
    @RequestMapping(value = "/versionlist", method = RequestMethod.GET, name = "获取版本的List")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/list", method = RequestMethod.GET, name = "获取列表,有分页的")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/simple/list", method = RequestMethod.GET, name = "获取列表,有分页的, 没有ZK信息")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/{configId}", method = RequestMethod.GET, name = "获取某个配置")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/zk/{configId}", method = RequestMethod.GET, name = "获取zk")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/download/{configId}", method = RequestMethod.GET, name = "下载配置文件")
     ...
     * @return
     */
    @RequestMapping(value = "/downloadfilebatch", method = RequestMethod.GET, name = "批量下载配置文件")
     ...
     * @return
     */
    @RequestMapping(value = "/history/{configId}", method = RequestMethod.GET, name = "获取列表,有分页的")
    @ResponseBody
    public JsonObjectBase getConfigHistoryList(@Valid ConfHistoryListForm confHistoryListForm,
                                               @PathVariable("configId") Long configId) {
        LOG.info("config[{}],confListForm:[{}]", configId, confHistoryListForm.toString());

        // 设置排序方式
        confHistoryListForm.getPage().setOrderBy(Columns.CREATE_TIME);
        confHistoryListForm.getPage().setOrder(PageOrderValidator.DESC);
        confHistoryListForm.getPage().setPageNo(confHistoryListForm.getPageNo());
        confHistoryListForm.getPage().setPageSize(confHistoryListForm.getPageSize());

        DaoPageResult<ConfigHistory> configHistorys = configHistoryMgrMgr.getConfigHistoryList(configId, confHistoryListForm);

        return buildListSuccess(configHistorys);
    }
