...
public class ZooController extends BaseController {
     ...
     */
    @NoAuth
    @RequestMapping(value = "/hosts", method = RequestMethod.GET, name = "获取Zookeeper地址")
    @ResponseBody
     ...
     */
    @NoAuth
    @RequestMapping(value = "/prefix", method = RequestMethod.GET, name = "获取ZK prefix")
    @ResponseBody
     ...
     * @return
     */
    @RequestMapping(value = "/zkdeploy", method = RequestMethod.GET, name = "获取ZK 部署情况")
    @ResponseBody
